...
@section('content')
        ...
        <div class="main main-raised">
            <div class="container">
                <div class="section">
                    <h2 class="title text-center">Register New Product</h2>
                    ...
                    <div class="row">
                        ...
                        <textarea class="form-control" placeholder="Write a long description..." rows="5" name="long_description"> {{ old('long_description')}}</textarea>
